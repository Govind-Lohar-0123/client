...
import {  removeToken } from '../MyProfile/auth/tokenAction';
            ...
            <StyledStack className="text-dark" >
                    ...
                    <Box className="username py-2" style={{ cursor: "pointer" }}>
                        <Box className="">
                            <LinkStyle component={routerLink} to="">
                                <img src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/profile-52e0dc.svg" alt="Govind " class="-dOa_b L_FVxe" width="24" height="24" />
                            </LinkStyle>
                            ...
                            <List className="gap-2">
                                ...
                                <ListItem>
                                    <Link component={routerLink} to="/supercoins">
                                        <img class="SFnind" src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/supercoin-ce8408.svg" alt="SuperCoin Zone" width="24" height="24" />
                                        <Typography variant="span" className="mx-2">Super Coins</Typography>
                                    </Link>
                                </ListItem>
                                <ListItem>
                                    <Link component={routerLink} to="/plus">
                                        <img class="SFnind" src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/fkplus-4ff29a.svg" alt="Flipkart Plus Zone" width="24" height="24" />
                                ...
                                <ListItem>
                                    <Link component={routerLink} to="/the-gift-card-store/1">
                                        <img class="SFnind" src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/giftCard-bd87e1.svg" alt="Gift Cards" width="24" height="24" />
                                ...
                                <ListItem>
                                    <Link component={routerLink} to="notification">
                                        <img class="SFnind" src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/notificationPreferences-cfffaf.svg" alt="Notifications" width="24" height="24" />
                            ...
                            <List className="gap-1">
                                ...
                                <ListItem>
                                    <Link component={routerLink} to="/rewards">
                                        <img class="SFnind" src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/rewards-fbd212.svg" alt="Rewards" width="24" height="24" />
                ...
                <Link className="text-dark " to="/view-carts" component={routerLink} >
                    <Link className="_3CowY2" style={{ cursor: "pointer", position: "relative" }} >
                        <StyledBadge variant="span" className="_2U7eDE">{cartSize.length}</StyledBadge><img src="https://static-assets-web.flixcart.com/batman-returns/batman-returns/p/images/header_cart-eed150.svg" alt="Cart" class="_1XmrCc" width="24" height="24" />
                    </Link>
