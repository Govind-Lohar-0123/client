...
export default function ProfileInfo() {
    ...
    const deactivateAccount = async () => {
        ...
        let flag = await userUpdate(perInfo, setResult);
        if (flag == true) {
    ...
    const saveUserInfoHandle = (e) => {
        ...
        if (name == "phone") {
            ...
            if (perInfo.phone != "" && len == 10) phone = perInfo.phone;
            setEditMobile(true);
        }
        else {
    ...
    return (
        <>
                ...
                <ComponentBox>
                    {(result.status) ? <Box className="alert alert-primary w-50 mx-auto mt-5">{result.msg}</Box> : ""}
                                    ...
                                    (editMobile) ?
                                        ...
                                        <Box className="d-flex gap-3 mt-4" style={{ height: "50px" }} >
                                            <FormControl variant="filled" style={{ height: "52px" }}>
                                                ...
                                                <FilledInput onChange={updateInputHandle} name="phone" value={perInfo.phone} />
                                            </FormControl>
