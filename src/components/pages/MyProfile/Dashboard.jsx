                            ...
                            <Box className="d-flex align-items-center gap-4" style={{
                                ...
                                <Link to="/account/orders" className="d-block w-100" component={routerLink}>
                                    <Box className="d-flex align-item-center w-100" style={{ justifyContent: "space-between" }}>
                                        ...
                                        <span class="a8RVPJ" style={{ transform: "rotate(180deg)" }}><svg width="15" height="16" viewBox="0 0 16 27" xmlns="http://www.w3.org/2000/svg" class="waolHD"><path d="M16 23.207L6.11 13.161 16 3.093 12.955 0 0 13.161l12.955 13.161z" fill="#878787" class="" ></path></svg></span>
                                    </Box>
                                </Link>
