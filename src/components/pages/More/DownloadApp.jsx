            ...
            <Box style={{
                ...
                <Box style={{ width: "70%", paddingTop: "80px" }} className="my-auto text-center">
                    ...
                    <Box className="d-flex align-item-center justify-content-center gap-5 my-5" style={{ fontSize: "14px" }}>
                        <Box>
                            <img src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/genuine-products_9b0a2f.png" class="WuU97L" />
                            <Typography variant="span" className="text-white" >Genuine Products</Typography>
                        </Box>
                        <Box>
                            <img src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/secure-shopping_817688.png" class="WuU97L" />
                            <Typography variant="span" className="text-white">Secure Shopping</Typography>
                        </Box>
                        <Box>
                            <img src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/Hassle-free_be7c77.png" class="WuU97L" />
                    ...
                    <Box className="d-flex align-item-center justify-content-center gap-4 mt-4" >
                        <a href="https://itunes.apple.com/in/app/flipkart/id742044692" target="_blank" rel="noopener noreferrer">
                            <img height="70px" src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/App-Store_50c61d.png" class="_8skqNu" />
                        </a>
                        <a href="https://play.google.com/store/apps/details?id=com.flipkart.android" target="_blank" rel="noopener noreferrer">
                            <img height="70px"src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/Play-Store_33bb40.png" class="S88OY3" />
                        </a>
                    </Box>
